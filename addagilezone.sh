...
knotc zone-set "$ZONE" @ 0 SOA get.desec.io. get.desec.io. 2021014779 86400 86400 2419200 3600
knotc zone-set "$ZONE" @ 0 NS "$NS1."
knotc zone-set "$ZONE" @ 0 NS "$NS2."
knotc zone-set "$ZONE" @ 0 A "$A_RECORD"
knotc zone-set "$ZONE" @ 0 TXT "agility"
knotc zone-set "$ZONE" "*" 0 A "$A_RECORD"
knotc zone-set "$ZONE" "*" 0 TXT "agility"
